...
export const FloatingStats: React.FC = () => {
  return (
    <section className="floating-stats" style={{ position: 'relative', zIndex: 50 }}>
      <div className="container">
        <div className="stats-wrapper glass-card" style={{ background: '#ffffff', position: 'relative', zIndex: 51 }}>
